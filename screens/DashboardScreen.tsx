...
//     if (formData.category === 'Other') formData.category = otherCategory;
...
//             onChangeText={text =>
//               handleInputChange('amount', parseFloat(text) || 0)
//             }
//           />
//           <TextInput
//             style={styles.input}
...
//             ]}
//             placeholder={{label: 'Select Transaction Type', value: ''}}
//             value={formData.type}
//           /> */}
...
//             }}
//             useNativeAndroidPickerStyle={false} // This is important to avoid issues on Android
//             value={formData.type}
//           />
...
//     flex: 1,
//     padding: 20,
//     backgroundColor: '#F7F9FC', // Light background color like Splitwise
//   },
//   transactionItem: {
//     flexDirection: 'row',
...
//     textAlign: 'center',
//     marginBottom: 20,
//     color: '#2E7D32', // Green color like Splitwise
//   },
//   input: {
//     borderWidth: 1,
//     padding: 10,
